...
{
    public partial class BedSideView4 : Form
    {
        public static BedSideView4 bed4singleton = new BedSideView4();
        ...
        public void UpdateColor(object sender, EventArgs e)
        {
            ...
            int.TryParse(CentralStation.centralsingleton.tbdi4.Text, out ditext); // Diastolic Value
            int.TryParse(CentralStation.centralsingleton.tbsy4.Text, out sytext); // Systolic Value
            int.TryParse(CentralStation.centralsingleton.tbpr4.Text, out prtext); // Pulse Value
            int.TryParse(CentralStation.centralsingleton.tbbr4.Text, out brtext); // Breathing Value
            int.TryParse(CentralStation.centralsingleton.tbtp4.Text, out tptext); // Temperature Value

            #region Textbox Color
            // Diastolic TextBox Color
            if (ditext < SocketSelection.diMin4 || ditext > SocketSelection.diMax4)
            {
                CentralStation.centralsingleton.tbdi4.BackColor = Color.Red;
            }
            else if (ditext > SocketSelection.diMin4 && ditext < SocketSelection.diMax4)
            {
                CentralStation.centralsingleton.tbdi4.BackColor = Color.FromArgb(105, 105, 105);
            }

            // Systolic TextBox Color
            if (sytext < SocketSelection.syMin4 || sytext > SocketSelection.syMax4)
            {
                CentralStation.centralsingleton.tbsy4.BackColor = Color.Red;
            }
            else if (sytext > SocketSelection.syMin4 && sytext < SocketSelection.syMax4)
            {
                CentralStation.centralsingleton.tbsy4.BackColor = Color.FromArgb(105, 105, 105);
            }

            // Pulse Textbox Color
            if (prtext < SocketSelection.prMin4 || prtext > SocketSelection.prMax4)
            {
                CentralStation.centralsingleton.tbpr4.BackColor = Color.Red;
            }
            else if (prtext > SocketSelection.prMin4 && prtext < SocketSelection.prMax4)
            {
                CentralStation.centralsingleton.tbpr4.BackColor = Color.FromArgb(105, 105, 105);
            }

            // Breathing Textbox Color
            if (brtext < SocketSelection.brMin4 || brtext > SocketSelection.brMax4)
            {
                CentralStation.centralsingleton.tbbr4.BackColor = Color.Red;
            }
            else if (brtext > SocketSelection.brMin4 && brtext < SocketSelection.brMax4)
            {
                CentralStation.centralsingleton.tbbr4.BackColor = Color.FromArgb(105, 105, 105);
            }

            // Temperature Textbox Color
            if (tptext < SocketSelection.tpMin4 || tptext < SocketSelection.tpMax4)
            {
                CentralStation.centralsingleton.tbtp4.BackColor = Color.Red;
            }
            else if (tptext > SocketSelection.tpMin4 && tptext > SocketSelection.tpMax4)
            {
                CentralStation.centralsingleton.tbtp4.BackColor = Color.FromArgb(105, 105, 105);
            }
            #endregion
        ...
        public void UpdateCentralStation(object sender, EventArgs e)
        {
            if (bloodActive == true)
            {
                CentralStation.centralsingleton.tbdi4.Text = DiastolicValueRandom();
                CentralStation.centralsingleton.tbsy4.Text = SystolicValueRandom();
            }
            else
            {
                CentralStation.centralsingleton.tbdi4.Text = "";
                CentralStation.centralsingleton.tbsy4.Text = "";
            }

            if (breathingActive == true)
            {
                CentralStation.centralsingleton.tbbr4.Text = BreathingValueRandom();
            }
            else { CentralStation.centralsingleton.tbbr4.Text = ""; }

            if (pulseActive == true)
            {
                CentralStation.centralsingleton.tbpr4.Text = PulseValueRandom();
            }
            else { CentralStation.centralsingleton.tbpr4.Text = ""; }

            if (tempActive == true)
            {
                CentralStation.centralsingleton.tbtp4.Text = TemperatureValueRandom();
            }
            else { CentralStation.centralsingleton.tbtp4.Text = ""; }
        ...
        private void InsertButton1_Click(object sender, EventArgs e)
        {
            if (moduleState1 == 0)
            {
                ...
                SocketSelection.socketsingleton.BedLabel.Text = "Bed 4";
        ...
        public static string SystolicValueRandom() // Returns syValue
        {
            ...
            if (randomizerSy <= 5)
            {
                syValue = SocketConfiguration.randomizer.Next(SocketSelection.syMin4 - 20, SocketSelection.syMin4 - 1);
            }
            else if ((randomizerSy > 5) && (randomizerSy < 95))
            {
                syValue = SocketConfiguration.randomizer.Next(SocketSelection.syMin4, SocketSelection.syMax4);
            }
            else if (randomizerSy >= 95)
            {
                syValue = SocketConfiguration.randomizer.Next(SocketSelection.syMax4 + 1, SocketSelection.syMax4 + 20);
            }
        ...
        public static string DiastolicValueRandom() // Returns diValue
        {
            ...
            if (randomizerDi <= 5)
            {
                diValue = SocketConfiguration.randomizer.Next(SocketSelection.diMin4 - 20, SocketSelection.diMin4 - 1);
            }
            else if ((randomizerDi > 5) && (randomizerDi < 95))
            {
                diValue = SocketConfiguration.randomizer.Next(SocketSelection.diMin4, SocketSelection.diMax4);
            }
            else if (randomizerDi >= 95)
            {
                diValue = SocketConfiguration.randomizer.Next(SocketSelection.diMin4 + 1, SocketSelection.diMax4 + 20);
            }
        ...
        public static string PulseValueRandom()
        {
            ...
            if (randomizerPR <= 5)
            {
                prValue = SocketConfiguration.randomizer.Next(SocketSelection.prMin4 - 20, SocketSelection.prMin4 - 1);
            }
            else if ((randomizerPR > 5) && (randomizerPR < 95))
            {
                prValue = SocketConfiguration.randomizer.Next(SocketSelection.prMin4, SocketSelection.prMax4);
            }
            else if (randomizerPR >= 95)
            {
                prValue = SocketConfiguration.randomizer.Next(SocketSelection.prMax4 + 1, SocketSelection.prMax4 + 20);
            }
        ...
        public static string BreathingValueRandom()
        {
            ...
            if (randomizerBR <= 5)
            {
                brValue = SocketConfiguration.randomizer.Next(SocketSelection.brMin4 - 5, SocketSelection.brMin4 - 1);
            }
            else if ((randomizerBR > 5) && (randomizerBR < 95))
            {
                brValue = SocketConfiguration.randomizer.Next(SocketSelection.brMin4, SocketSelection.brMax4);
            }
            else if (randomizerBR >= 95)
            {
                brValue = SocketConfiguration.randomizer.Next(SocketSelection.brMax4 + 1, SocketSelection.brMax4 + 50);
            }
        ...
        public static string TemperatureValueRandom()
        {
            ...
            {
                tempValue = SocketConfiguration.randomizer.Next(SocketSelection.tpMin4 - 25, SocketSelection.tpMin4 - 1);
            }
            else if ((randomizerTemp > 25) && (randomizerTemp < 75))
            {
                tempValue = SocketConfiguration.randomizer.Next(SocketSelection.tpMin4, SocketSelection.tpMax4);
            }
            else if (randomizerTemp >= 75)
            {
                tempValue = SocketConfiguration.randomizer.Next(SocketSelection.tpMax4 + 1, SocketSelection.tpMax4 + 45);
            }
