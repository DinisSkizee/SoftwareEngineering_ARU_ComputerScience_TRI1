...
namespace FinalProject
{
    public partial class BedSideView4 : Form
    {
        ...
        public void UpdateColor(object sender, EventArgs e)
        {
            ...
            int.TryParse(CentralStation.centralsingleton.tbdi4l.Text, out ditext); // Diastolic Value
            int.TryParse(CentralStation.centralsingleton.tbsy4l.Text, out sytext); // Systolic Value
            int.TryParse(CentralStation.centralsingleton.tbpr4l.Text, out prtext); // Pulse Value
            int.TryParse(CentralStation.centralsingleton.tbbr4l.Text, out brtext); // Breathing Value
            int.TryParse(CentralStation.centralsingleton.tbtp4l.Text, out tptext); // Temperature Value

            #region Textbox Color
            // Diastolic TextBox Color
            if (ditext < SocketConfiguration.diMin4 || ditext > SocketConfiguration.diMax4)
            {
                CentralStation.centralsingleton.tbdi4.BackColor = Color.Red;
                CentralStation.centralsingleton.tbdi4l.BackColor = Color.Red;
            }
            else if (ditext > SocketConfiguration.diMin4 && ditext < SocketConfiguration.diMax4)
            {
                CentralStation.centralsingleton.tbdi4.BackColor = Color.FromArgb(105, 105, 105);
                CentralStation.centralsingleton.tbdi4l.BackColor = Color.FromArgb(105, 105, 105);
            }

            // Systolic TextBox Color
            if (sytext < SocketConfiguration.syMin4 || sytext > SocketConfiguration.syMax4)
            {
                CentralStation.centralsingleton.tbsy4.BackColor = Color.Red;
                CentralStation.centralsingleton.tbsy4l.BackColor = Color.Red;
            }
            else if (sytext > SocketConfiguration.syMin4 && sytext < SocketConfiguration.syMax4)
            {
                CentralStation.centralsingleton.tbsy4.BackColor = Color.FromArgb(105, 105, 105);
                CentralStation.centralsingleton.tbsy4l.BackColor = Color.FromArgb(105, 105, 105);
            }

            // Pulse Textbox Color
            if (prtext < SocketConfiguration.prMin4 || prtext > SocketConfiguration.prMax4)
            {
                CentralStation.centralsingleton.tbpr4.BackColor = Color.Red;
                CentralStation.centralsingleton.tbpr4l.BackColor = Color.Red;
            }
            else if (prtext > SocketConfiguration.prMin4 && prtext < SocketConfiguration.prMax4)
            {
                CentralStation.centralsingleton.tbpr4.BackColor = Color.FromArgb(105, 105, 105);
                CentralStation.centralsingleton.tbpr4l.BackColor = Color.FromArgb(105, 105, 105);
            }

            // Breathing Textbox Color
            if (brtext < SocketConfiguration.brMin4 || brtext > SocketConfiguration.brMax4)
            {
                CentralStation.centralsingleton.tbbr4.BackColor = Color.Red;
                CentralStation.centralsingleton.tbbr4l.BackColor = Color.Red;
            }
            else if (brtext > SocketConfiguration.brMin4 && brtext < SocketConfiguration.brMax4)
            {
                CentralStation.centralsingleton.tbbr4.BackColor = Color.FromArgb(105, 105, 105);
                CentralStation.centralsingleton.tbbr4l.BackColor = Color.FromArgb(105, 105, 105);
            }

            // Temperature Textbox Color
            if (tptext < SocketConfiguration.tpMin4 || tptext < SocketConfiguration.tpMax4)
            {
                CentralStation.centralsingleton.tbtp4.BackColor = Color.Red;
                CentralStation.centralsingleton.tbtp4l.BackColor = Color.Red;
            }
            else if (tptext > SocketConfiguration.tpMin4 && tptext > SocketConfiguration.tpMax4)
            {
                CentralStation.centralsingleton.tbtp4.BackColor = Color.FromArgb(105, 105, 105);
                CentralStation.centralsingleton.tbtp4l.BackColor = Color.FromArgb(105, 105, 105);
            }
            #endregion
        ...
        public void UpdateCentralStation(object sender, EventArgs e)
        {
            if (bloodActive == true)
            {
                CentralStation.centralsingleton.tbdi4l.Text = dirandom.ToString();
                CentralStation.centralsingleton.tbsy4l.Text = syrandom.ToString();
            }
            else
            {
                CentralStation.centralsingleton.tbdi4l.Text = "";
                CentralStation.centralsingleton.tbsy4l.Text = "";
            }

            if (breathingActive == true)
            {
                CentralStation.centralsingleton.tbbr4l.Text = brrandom.ToString();
            }
            else { CentralStation.centralsingleton.tbbr4l.Text = ""; }

            if (pulseActive == true)
            {
                CentralStation.centralsingleton.tbpr4l.Text = prrandom.ToString();
            }
            else { CentralStation.centralsingleton.tbpr4l.Text = ""; }

            if (tempActive == true)
            {
                CentralStation.centralsingleton.tbtp4l.Text = tprandom.ToString();
            }
            else { CentralStation.centralsingleton.tbtp4l.Text = ""; }
        }
