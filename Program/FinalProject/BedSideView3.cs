...
namespace FinalProject
{
    public partial class BedSideView3 : Form
    {
        ...
        public void UpdateColor(object sender, EventArgs e)
        {
            ...
            int.TryParse(CentralStation.centralsingleton.tbdi3l.Text, out ditext); // Diastolic Value
            int.TryParse(CentralStation.centralsingleton.tbsy3l.Text, out sytext); // Systolic Value
            int.TryParse(CentralStation.centralsingleton.tbpr3l.Text, out prtext); // Pulse Value
            int.TryParse(CentralStation.centralsingleton.tbbr3l.Text, out brtext); // Breathing Value
            int.TryParse(CentralStation.centralsingleton.tbtp3l.Text, out tptext); // Temperature Value

            #region Textbox Color
            // Diastolic TextBox Color
            if (ditext < SocketConfiguration.diMin3 || ditext > SocketConfiguration.diMax3)
            {
                CentralStation.centralsingleton.tbdi3.BackColor = Color.Red;
                CentralStation.centralsingleton.tbdi3l.BackColor = Color.Red;
            }
            else if (ditext > SocketConfiguration.diMin3 && ditext < SocketConfiguration.diMax3)
            {
                CentralStation.centralsingleton.tbdi3.BackColor = Color.FromArgb(105, 105, 105);
                CentralStation.centralsingleton.tbdi3l.BackColor = Color.FromArgb(105, 105, 105);
            }

            // Systolic TextBox Color
            if (sytext < SocketConfiguration.syMin3 || sytext > SocketConfiguration.syMax3)
            {
                CentralStation.centralsingleton.tbsy3.BackColor = Color.Red;
                CentralStation.centralsingleton.tbsy3l.BackColor = Color.Red;
            }
            else if (sytext > SocketConfiguration.syMin3 && sytext < SocketConfiguration.syMax3)
            {
                CentralStation.centralsingleton.tbsy3.BackColor = Color.FromArgb(105, 105, 105);
                CentralStation.centralsingleton.tbsy3l.BackColor = Color.FromArgb(105, 105, 105);

            }

            // Pulse Textbox Color
            if (prtext < SocketConfiguration.prMin3 || prtext > SocketConfiguration.prMax3)
            {
                CentralStation.centralsingleton.tbpr3.BackColor = Color.Red;
                CentralStation.centralsingleton.tbpr3l.BackColor = Color.Red;

            }
            else if (prtext > SocketConfiguration.prMin3 && prtext < SocketConfiguration.prMax3)
            {
                CentralStation.centralsingleton.tbpr3.BackColor = Color.FromArgb(105, 105, 105);
                CentralStation.centralsingleton.tbpr3l.BackColor = Color.FromArgb(105, 105, 105);

            }

            // Breathing Textbox Color
            if (brtext < SocketConfiguration.brMin3 || brtext > SocketConfiguration.brMax3)
            {
                CentralStation.centralsingleton.tbbr3.BackColor = Color.Red;
                CentralStation.centralsingleton.tbbr3l.BackColor = Color.Red;
            }
            else if (brtext > SocketConfiguration.brMin3 && brtext < SocketConfiguration.brMax3)
            {
                CentralStation.centralsingleton.tbbr3.BackColor = Color.FromArgb(105, 105, 105);
                CentralStation.centralsingleton.tbbr3l.BackColor = Color.FromArgb(105, 105, 105);
            }

            // Temperature Textbox Color
            if (tptext < SocketConfiguration.tpMin3 || tptext < SocketConfiguration.tpMax3)
            {
                CentralStation.centralsingleton.tbtp3.BackColor = Color.Red;
                CentralStation.centralsingleton.tbtp3l.BackColor = Color.Red;
            }
            else if (tptext > SocketConfiguration.tpMin3 && tptext > SocketConfiguration.tpMax3)
            {
                CentralStation.centralsingleton.tbtp3.BackColor = Color.FromArgb(105, 105, 105);
                CentralStation.centralsingleton.tbtp3l.BackColor = Color.FromArgb(105, 105, 105);
            }
            #endregion
        ...
        public void UpdateCentralStation(object sender, EventArgs e)
        {
            if (bloodActive == true)
            {
                CentralStation.centralsingleton.tbdi3l.Text = dirandom.ToString();
                CentralStation.centralsingleton.tbsy3l.Text = syrandom.ToString();
            }
            else
            {
                CentralStation.centralsingleton.tbdi3l.Text = "";
                CentralStation.centralsingleton.tbsy3l.Text = "";
            }

            if (breathingActive == true)
            {
                CentralStation.centralsingleton.tbbr3l.Text = brrandom.ToString();
            }
            else { CentralStation.centralsingleton.tbbr3l.Text = ""; }

            if (pulseActive == true)
            {
                CentralStation.centralsingleton.tbpr3l.Text = prrandom.ToString();
            }
            else { CentralStation.centralsingleton.tbpr3l.Text = ""; }

            if (tempActive == true)
            {
                CentralStation.centralsingleton.tbtp3l.Text = tprandom.ToString();
            }
